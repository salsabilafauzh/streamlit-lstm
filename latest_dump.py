...
companies = {
    "TLKM.JK": "PT. Telkom Indonesia (Persero) Tbk [TLKM]",
    "ISAT.JK": "PT. Indosat Tbk [ISAT]",
    "EXCL.JK": "PT. XL Axiata Tbk [EXCL]"
}
...
def load_saved_model():
    model=load_model('./pages/saved_model/lstm_model_5_300.h5')
    return model
